...
if selected == "Home":
    ...
    st.markdown("<p class='justified-text'>Insideairbnb.com es un sitio web en el que se publican conjuntos de datos extraídos de la web de 'instantáneas' de ciudades. He descargado los archivos de Hawaii de la situación desde 2018.</p>", unsafe_allow_html=True)
...
if selected == "Información":
    ...
    tab1, tab2, tab3 = st.tabs(
        ['Acomodaciones','Potencialmente Ilegales','Volcanes']) 
    with tab1:
    ...
    with tab2:
        ...
        st.write('Encontrando las coordenadas de los potenciales hoteles Ilegales')
        ...
        st.write('Cantidad de Anuncios por Anfitrión')
...
if selected == "Power BI":
    st.markdown("""
            ## Este es un dashboard de PowerBI incrustado en una aplicación de Streamlit.
                Puedes interactuar con el dashboard directamente desde aquí.
        """)
...
if selected == "Predictor de Precios": 
    ...
    # Función para preveer el precio
